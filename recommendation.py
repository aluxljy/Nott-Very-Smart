        ...
        if word == stall:
            ...
            if is_beverage == "yes":
                try:
                    ...
                    recommendation = menu.sample(n=1, weights='price', random_state=random.randint(0, 21))  # sample a random row
                    item = recommendation['item_name'].to_string(index=False, header=False)   # hide index and header of data frame
